...
from app.services.database import init_db, SessionLocal, User
from app.services.auth import exchange_code_for_user
    ...
    try:
        ...
        if not user:
            user = User(
                ...
                display_name=profile.get("displayname", profile["login"]),
