...
from services.scoring import calculate_rankings
...
def leaderboard_page():
    ...
    for i, entry in enumerate(rankings):
        ...
        with ui.row().classes("items-center gap-4 mb-3 w-full"):
            ...
            ui.label(entry["display_name"] or entry["login"]).classes("flex-1 font-medium")
            ui.label(f"{entry['total_points']} pts").classes("font-bold text-blue-600")
